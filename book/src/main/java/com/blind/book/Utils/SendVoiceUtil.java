...
@NoArgsConstructor
@Data
public class SendVoiceUtil extends WebSocketListener {
    ...
    private static final String appid = "fe8adb86"; //在控制台-我的应用获取
    private static final String apiSecret = "ZjY3Y2Q4OWZiN2M2YmY0NjhlM2YwNjQy"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiKey = "8ba77ab226316a76755ff7cd8b580be8"; //在控制台-我的应用-语音听写（流式版）获取
        ...
        if (resp != null) {
            ...
            if (resp.getData() != null) {
                ...
                if (resp.getData().getStatus() == 2) {
                    ...
                    dateEnd = new Date();
                    com.blind.book.domain.WebSocket webSocket1 = wsMap.get(deviceId);
                    if(!Objects.isNull(webSocket1)) {
                        webSocket1.sendMessage("{\"type\":\"speechRec\",\"content\":" + decoder.toString()+ "}");
                    }
                    decoder.discard();
    ...
    public void getReVoice(String deviceId,FileInputStream fis) throws Exception {
        // 构建鉴权url
        ...
        sendVoiceUtil.setDeviceId(deviceId);
        sendVoiceUtil.setFis(fis);
        WebSocket webSocket = client.newWebSocket(request, sendVoiceUtil);
    }
