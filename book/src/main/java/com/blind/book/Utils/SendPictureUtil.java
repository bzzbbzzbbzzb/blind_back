...
public class SendPictureUtil {
    ...
    //控制台获取以下信息
    private static String APPID = "fe8adb86";
    private static String apiSecret = "ZjY3Y2Q4OWZiN2M2YmY0NjhlM2YwNjQy";
    private static String apiKey = "8ba77ab226316a76755ff7cd8b580be8";
    /**
     * 请求主方法
     * @return 返回服务结果
     * @throws Exception 异常
     */
    public String doRequest(String picture) throws Exception {
        ...
        String params = buildParam(picture);
     ...
     * @return 参数字符串
     */
    private String  buildParam(String picture) throws IOException {
        String param = "{"+
                "    \"header\": {"+
                "        \"app_id\": \""+APPID+"\","+
                "        \"status\": 3"+
